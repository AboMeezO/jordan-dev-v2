...
export const remindCommand = commandTree({
	...
	usage: {
		...
		examples: [
			{
				...
				description:
					"Remind you in this channel after ten minutes.",
			},
			{
				command: "!remind 9d 12h ship it",
				description:
					"Remind you after 9 days and 12 hours.",
			},
			{
				command:
					"!remind --dm --time 9d 12h shall i remember my madness",
				description:
					"Send a DM reminder after 9 days and 12 hours.",
			},
			{
				command: "!remind --time=9d 12h ship it",
				description:
					"Use an inline flag to specify the time",
			},
			{
				command: "!remind --dm 09:30 standup",
				description:
					"Send the reminder to your DMs at 09:30.",
			},
		],
		formats: [
			"!remind <time> <message>",
		...
		options: [
			{
				description:
					"Send the reminder privately instead of in this channel.",
				name: "dm",
			},
			{
				description:

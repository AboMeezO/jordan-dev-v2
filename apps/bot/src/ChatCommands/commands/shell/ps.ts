...
export const psCommand = commandTree({
  ...
  description: "Print bot process and Discord cache status.",
  name: "ps",
  permission: "public",
  usage: {
    examples: [
      {
        command: "ps",
        description: "Show process and Discord cache counters.",
      },
    ],
    formats: ["ps"],
    useCases: ["Quickly inspect whether the bot process is alive and connected."],
  },

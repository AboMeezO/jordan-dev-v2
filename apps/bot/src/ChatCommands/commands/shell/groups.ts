...
import { roleNames, shellOutput, userDisplayName } from "./format.js";
...
export const groupsCommand = commandTree({
  ...
  usage: {
    examples: [
      {
        command: "groups",
        description: "List your role names in server order.",
      },
      {
        command: "roles",
    ...
    formats: ["groups"],
    useCases: ["Inspect the Discord role groups attached to your member profile."],
  },

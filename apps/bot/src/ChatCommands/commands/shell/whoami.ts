...
export const whoamiCommand = commandTree({
	...
	description:
		"Print your Discord identity in this server.",
	name: "whoami",
	permission: "public",
	usage: {
		examples: [
			{
				command: "whoami",
				description:
					"Show your user, server nickname, roles, and permissions.",
			},
		],
		formats: ["whoami"],
		useCases: [
			"Confirm which Discord account and server identity invoked a command.",
		],
	},

...
export const idCommand = commandTree({
	...
	description:
		"Print Discord IDs and role groups for your account.",
	name: "id",
	permission: "public",
	usage: {
		examples: [
			{
				command: "id",
				description:
					"Show Discord user, guild, channel, role, and permission IDs.",
			},
		],
		formats: ["id"],
		useCases: [
			"Copy exact Discord IDs without opening developer mode menus.",
		],
	},

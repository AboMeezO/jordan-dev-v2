...
function AdminRolesPage() {
  ...
  const deleteTarget = deleteRoleId
    ? rolesQuery.data?.find((r) => r.id === deleteRoleId)
    : null

  const [managePermsRoleId, setManagePermsRoleId] = useState<string | null>(
    null,
  )
          ...
          <DialogContent>
            ...
            >
              ...
              <DialogFooter className="shrink-0">
                ...
                <Button
                  disabled={!editName.trim() || updateRoleMutation.isPending}
                  type="submit"
                >
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                {deleteTarget?.name ?? 'this role'}"? This action cannot be
                undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
            ...
            >
              ...
              <DialogBody>
                <div className="space-y-4">
                  ...
                  {permsError && (
                    <p className="text-sm text-destructive">{permsError}</p>
                  )}
                </div>
              </DialogBody>
              <DialogFooter className="shrink-0">

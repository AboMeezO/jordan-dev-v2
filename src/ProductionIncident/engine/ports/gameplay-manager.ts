import type { ActionId, IncidentId, PlayerId, SessionId } from "../domain/ids.js";
import type { GameSession, Incident } from "../domain/index.js";
...
export interface GameplayManager {
  closeVote(input: CloseVoteInput): Promise<EngineCommandResult<GameplayMutation>>;
  generateIncident(

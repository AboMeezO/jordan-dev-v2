(function (y, v) {
	...
	var Oe = Math.pow,
		...
		D = (y, v) => {
			...
			if (Z)
				for (var N of Z(v)) Me.call(v, N) && Le(y, N, v[N]);
			return y;
		},
		M = (y, v) => nr(y, or(v));
	var je = (y, v) => {
		...
		new Promise((R, O) => {
			var X = (P) => {
				...
				q = (P) =>
					P.done
						? R(P.value)
						: Promise.resolve(P.value).then(X, j);
	...
	const se = "[modern-screenshot]",
		...
		Qe = (e) => e.tagName === "use",
		V = (e) =>
			I(e) && typeof e.style != "undefined" && !H(e),
		Ze = (e) => e.nodeType === 8,
		et = (e) => e.nodeType === 3,
		$ = (e) => e.tagName === "IMG",
		Y = (e) => e.tagName === "VIDEO",
	...
	function ge(e, t) {
		return new Promise((r, n) => {
			...
			((i.onload = () => r(i.result)),
				(i.onerror = () => n(i.error)),
				(i.onabort = () =>
					n(new Error(`Failed read blob to ${t}`))),
				t === "dataUrl"
					? i.readAsDataURL(e)
	...
	function L(e, t) {
		return new Promise((r) => {
			...
			if ((n && (c = setTimeout(l, n)), Y(o))) {
				...
				const m = l,
					f = (h) => {
						(s == null || s("Failed video load", d, h),
							a == null || a(h),
							l());
					};
				((u = () => {
		...
		return C(this, null, function* () {
			V(e) &&
				($(e) || Y(e)
					...
					: yield Promise.all(
							["img", "video"].flatMap((r) =>
								Array.from(e.querySelectorAll(r)).map((n) =>
									L(n, t),
								),
							),
						));
	...
	const he = (function () {
		let t = 0;
		const r = () =>
			`0000${((Math.random() * Oe(36, 4)) << 0).toString(36)}`.slice(
				-4,
			);
		return () => ((t += 1), `u${r()}${t}`);
	})();
	...
	function ye(e, t) {
		return C(this, null, function* () {
			...
			const {
				...
				a = !!(t != null && t.debug),
				s =
					(f = t == null ? void 0 : t.features) != null
						? f
						: !0,
				o =
					(h = e.ownerDocument) != null
						? h
						: U
							? window.document
							: void 0,
						...
						workers: [
							...
							.map(() => {
								try {
									...
									return (
										l.log.warn("Failed to new Worker", b),
										null
									);
								}
							})
...
`);
		...
		return C(this, null, function* () {
			...
			const s = yield L(e, {
				...
				u = () => {
					try {
						c == null ||
							c.drawImage(s, 0, 0, o.width, o.height);
					} catch (l) {
	...
	function St(e, t) {
		...
		try {
			if (
				(r = e == null ? void 0 : e.contentDocument) !=
					null &&
				r.documentElement
			)
	...
	function Ee(e, t, r) {
		const { defaultComputedStyles: n } = r,
			...
			a = H(e) && i !== "svg",
			s = a
				? Nt.map((g) => [g, e.getAttribute(g)]).filter(
						([, g]) => g !== null,
					)
				: [],
			o = [
		...
		(a
			? ((d = l.createElementNS(K, "svg")),
				(m = d.ownerDocument.createElementNS(
					d.namespaceURI,
					i,
				)),
				s.forEach(([g, p]) => {
	...
	function Ce(e, t, r) {
		...
		function s(c) {
			...
			if (m) {
				let f = a.get(m);
				(f || ((f = new Map()), a.set(m, f)),
					f.set(c, [u, l]));
			}
			(t.get(c) === u && !l) ||
				(m ? i.push(m) : n.set(c, [u, l]));
		}
		return n;
	}
	function Rt(e, t, r, n) {
		...
		(l.delete("transition-property"),
			...
			((d = l.get("background-clip")) == null
				? void 0
				: d[0]) === "text" &&
				t.classList.add("______background-clip--text"),
			le &&
				(l.has("font-kerning") ||
					l.set("font-kerning", ["normal", ""]),
				(((m = l.get("overflow-x")) == null
					? void 0
					: m[0]) === "hidden" ||
					((f = l.get("overflow-y")) == null
						? void 0
						: f[0]) === "hidden") &&
					((h = l.get("text-overflow")) == null
						? void 0
						: h[0]) === "ellipsis" &&
  ...
  `);
	...
	function ve(e, t, r, n, i) {
		return C(this, null, function* () {
			...
			(n.isEnable("restoreScrollPosition") && Ut(e, a),
				t.appendChild(a));
		});
	}
	function Ae(e, t, r, n) {
	...
	function _t(e, t) {
		...
		if (
			(r &&
				s.setProperty("background-color", r, "important"),
		...
		return C(this, null, function* () {
			...
			if (i && a && I(e) && (V(e) || H(e))) {
				...
				if (t.isEnable("copyScrollbar")) {
					const w = [
						(u = h.get("overflow-x")) == null
							? void 0
							: u[0],
						(l = h.get("overflow-y")) == null
							? void 0
							: l[0],
					];
					g =
				...
				const p =
						(d = h.get("text-transform")) == null
							? void 0
							: d[0],
					E = we(
						(m = h.get("font-family")) == null
							? void 0
							: m[0],
					),
					b = E
			...
			((E = {
				...
				(E.response = C(this, null, function* () {
					...
					return !G && r.startsWith("http") && g.length
						? new Promise((A, F) => {
								(g[u.size & (g.length - 1)].postMessage(
									D({ rawUrl: r }, T),
								),
									(E.resolve = A),
									(E.reject = F));
		...
		if (s) {
			const c = `#${s}`,
				u = t.shadowRoots.reduce(
					(l, d) =>
						l != null ? l : d.querySelector(`svg ${c}`),
					r == null ? void 0 : r.querySelector(`svg ${c}`),
				);
			if (
				(a && e.setAttribute("href", c),
				n != null && n.querySelector(c))
			)
				return [];
			if (u)
				return (
					n == null || n.appendChild(u.cloneNode(!0)),
					[]
				);
			if (a)
				return [
					z(t, { url: a, responseType: "text" }).then(
						(l) => {
							n == null ||
...
`),
					...
					const c = Array.from(r.styleSheets).filter(
							(f) => {
								try {
									return (
										"cssRules" in f && !!f.cssRules.length
									);
								} catch (h) {
									return (
										t.log.warn(
						...
						m
							.filter((f) => {
								...
								return (
									...
									((h = we(
										f.style.getPropertyValue("font-family"),
									)) == null
										? void 0
										: h.some((g) => i.has(g)))
								);
...
`;
	...
	function Yt(e, t) {
		const { width: r, height: n } = t,
			...
			a = i.ownerDocument.createElementNS(
				i.namespaceURI,
				"foreignObject",
			);
		return (
	...
	function x(e, t) {
		return C(this, null, function* () {
			...
			if (
				["image/png", "image/jpeg"].includes(a) &&
				s &&
				ie &&
				Xe
			) {
	...
	function Fe(e, t) {
		return C(this, null, function* () {
			const r = yield k(e, t),
				...
				s = yield x(r),
				o = fe(n, i, a),
				c = o.ownerDocument.createElementNS(
					o.namespaceURI,
					"image",
				);
			return (
	...
	function Kt(e, t) {
		return C(this, null, function* () {
			const r = yield k(e, t),
				...
				c =
					o === "image/svg+xml" ? yield Fe(r) : yield x(r),
				u = _(c, n);
			return (
	...
	function Qt(e, t) {
		return C(this, null, function* () {
			return x(
				yield k(e, M(D({}, t), { type: "image/jpeg" })),
			);
		});
	}
	function Zt(e, t) {
	...
	function er(e, t) {
		return C(this, null, function* () {
			return x(
				yield k(e, M(D({}, t), { type: "image/png" })),
			);
		});
	}
	function tr(e, t) {
		return C(this, null, function* () {
			return x(
				yield k(e, M(D({}, t), { type: "image/webp" })),
			);
		});
	}
	((y.createContext = ye),
